...
Kubernetes supports [Sidecar Containers](https://kubernetes.io/docs/concepts/workloads/pods/sidecar-containers/) from version 1.28 by way of **initContainers[x].restartPolicy=Always**.
