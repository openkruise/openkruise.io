...
$ helm install kruise openkruise/kruise --version 1.5.5
```
...
$ helm upgrade kruise openkruise/kruise --version 1.5.5 [--force]
```
...
| `manager.image.tag`                       | kruise-manager/kruise-daemon 镜像版本                         | `1.5.5`                       |
