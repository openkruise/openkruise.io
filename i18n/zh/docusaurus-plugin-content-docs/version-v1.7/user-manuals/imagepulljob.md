...
1. 节点上面安装云厂商的凭据提供插件，比如：[AWS](https://github.com/awslabs/amazon-ecr-credential-helper)。
2. 配置凭据提供插件的配置文件，如下：
```
apiVersion: v1
kind: ConfigMap
...
3. 凭据提供插件需要身份认证来请求云厂商获取镜像仓库临时凭证。

<Tabs>
  <TabItem value="aws" label="aws" default>

AWS提供了多种[认证方式](https://docs.aws.amazon.com/sdk-for-go/v1/developer-guide/configuring-sdk.html)，如下：
