...
# 安装最新版本。
$ helm install kruise-rollout openkruise/kruise-rollout --version 0.6.2
```
...
# 升级到最新版本。
$ helm upgrade kruise-rollout openkruise/kruise-rollout --version 0.6.2 [--force]
```
...
```bash
$ helm install kruise-rollout openkruise/kruise-rollout --version 0.6.2 --set resources.limits.memory=2Gi
```
