...
|----------------------|--------------------------------------------------------|----------------------|---------------------------------------------------------------------------------------------------------------------|
| Lifecycle Management | create                                                 | Partially Compatible | Network access control is supported; see [E2B Network Controls](./user-manuals/security/e2b-network-controls.md). MCP integration implementation pending. |
|                      | get\_info                                              | Fully Compatible     |                                                                                                                     |
|                      | list                                                   | Fully Compatible     |                                                                                                                     |
|                      | kill                                                   | Fully Compatible     |                                                                                                                     |
|                      | pause                                                  | Fully Compatible     | Pause is synchronous: the request blocks until the sandbox reaches the Paused state                                 |
