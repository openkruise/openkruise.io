        ...
        },
        {
            ...
            items: [
                ...
                'user-manuals/service-qualities',
                {
                    type: 'category',
                    label: 'Network',
                    link: { type: 'doc', id: 'user-manuals/network' },
                    collapsed: true,
                    items: [
                        'user-manuals/network/kubernetes',
                        'user-manuals/network/alibabacloud',
                        'user-manuals/network/volcengine',
                        'user-manuals/network/amazonwebservices',
                        'user-manuals/network/tencentcloud',
                        'user-manuals/network/jdcloud',
                        'user-manuals/network/hwcloud',
                    ],
                },
