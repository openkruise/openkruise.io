...
| `image.tag`                                | Tag for kruise-game image                                                                        | `v1.1.0`                         |
...
| `kruiseGame.logging.format`                | Log output format (console/json)                                                                 | `console`                        |
| `kruiseGame.logging.jsonPreset`            | JSON log preset (kibana/otel)                                                                    | `kibana`                         |
| `kruiseGame.logging.enableOTelLogs`        | Enable OTLP log export                                                                           | `false`                          |
| `kruiseGame.tracing.enabled`               | Enable OpenTelemetry tracing                                                                     | `false`                          |
| `kruiseGame.tracing.collectorEndpoint`     | OTel Collector gRPC endpoint                                                                     | `localhost:4317`                 |
| `kruiseGame.tracing.collectorToken`        | OTLP authentication token                                                                        | `""`                             |
| `kruiseGame.tracing.samplingRate`          | Tracing sampling rate (0.0-1.0)                                                                  | `1.0`                            |
| `kruiseGame.pprof.bindAddress`             | pprof bind address (empty to disable)                                                            | `""`                             |
